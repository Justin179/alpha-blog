...
class OrderDetailsControllerTest < ActionController::TestCase
  ...
  test "should create order_detail" do
    assert_difference('OrderDetail.count') do
      post :create, order_detail: { item: @order_detail.item, order_id: @order_detail.order_id, price: @order_detail.price, quantity: @order_detail.quantity, subtotal: @order_detail.subtotal, totalamount: @order_detail.totalamount }
    end
  ...
  test "should update order_detail" do
    patch :update, id: @order_detail, order_detail: { item: @order_detail.item, order_id: @order_detail.order_id, price: @order_detail.price, quantity: @order_detail.quantity, subtotal: @order_detail.subtotal, totalamount: @order_detail.totalamount }
    assert_redirected_to order_detail_path(assigns(:order_detail))
  end
